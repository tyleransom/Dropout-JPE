...
ipath = '../../../output/utility-grid-search/CRRA-0-1/';
...
% check CRRA value
assert(norm(CRRA-0.1,Inf)<1e-6, ['CRRA wrongly read in; CRRA is supposed to be 0.1 but it is actually ',num2str(CRRA)])
