...
ipath = '../../../output/utility-grid-search/CRRA-0-8/';
...
% check CRRA value
assert(norm(CRRA-0.8,Inf)<1e-6, ['CRRA wrongly read in; CRRA is supposed to be 0.8 but it is actually ',num2str(CRRA)])
