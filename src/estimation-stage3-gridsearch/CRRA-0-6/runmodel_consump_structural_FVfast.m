...
ipath = '../../../output/utility-grid-search/CRRA-0-6/';
...
% check CRRA value
assert(norm(CRRA-0.6,Inf)<1e-6, ['CRRA wrongly read in; CRRA is supposed to be 0.6 but it is actually ',num2str(CRRA)])
