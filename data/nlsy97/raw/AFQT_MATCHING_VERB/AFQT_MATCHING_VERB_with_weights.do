...
set more off
capture log close
log using "/afs/econ.duke.edu/data/apm16/Dropout/y97/RawData/AFQT_MATCHING_VERB/AFQT_MATCHING_VERB_with_weights.log", replace
...
kdensity asvabVerb if sample==0&age==16, addplot(kdensity asvabVerb if sample==1&age==16, lpattern(_)) title(Figure 1: AFQT Scores at Age 16) ///
